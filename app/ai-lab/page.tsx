...
function HeroSection() {
  return (
    <section className="relative overflow-hidden px-3 pb-8 pt-6 sm:px-4 sm:pb-20 sm:pt-14 md:pb-28 md:pt-24">
...
function ToolsSection() {
  return (
    <section
      id="lab-tools"
      className="relative scroll-mt-20 px-3 py-11 sm:px-4 sm:py-20 md:py-28"
    >
      <div className="relative mx-auto max-w-6xl">
        <SectionHeader
  ...
  return (
    <section className="relative px-3 pb-14 pt-8 sm:px-4 sm:pb-24 sm:pt-12 md:pb-32">
      <div className="relative mx-auto grid max-w-6xl gap-4 md:grid-cols-[minmax(0,1fr)_minmax(280px,0.42fr)] md:items-stretch">
        <div className="relative min-w-0 overflow-hidden rounded-[1.15rem] border border-hairline bg-card/94 px-5 py-10 shadow-[var(--shadow-chat-depth),inset_0_1px_0_0_var(--shine-inset)] backdrop-blur-2xl dark:bg-card/[0.42] sm:rounded-[1.75rem] sm:px-10 sm:py-14 md:px-12">
